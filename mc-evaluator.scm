...
;; Procedure includes a tag, parameters, body and environment (is environment necessary?)
...
(define (user-print object)
  (if (my-compound-procedure? object)
...
; test	((let*? exp) (display (let*->nested-lets exp) env))
...
(define (apply procedure arguments)
  (cond ((primitive-procedure? procedure)
	...
	((my-compound-procedure? procedure)
	 (eval-sequence
